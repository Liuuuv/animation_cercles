...
class Affichage:
    ...
    def calculer_coefficients_discret(self):
        ...
        if nb_coordonnes<self.nb_cercles:
            for n in range(nb_coordonnes,self.nb_cercles):
                self.liste_phases[n]=0
                self.liste_rayons[n]=0
        
        print(len(self.liste_rayons))
