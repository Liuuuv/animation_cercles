    ...
    def dessiner(self):
        ...
        if gerer_epaisseur:
            ...
            for i in range(len(self.liste_points)-1):
                ...
                epaisseur=min(int(epaisseur_max/(self.distance_points[(self.liste_points[i][0],self.liste_points[i][1])])**0.2),epaisseur_max)
                
                py.draw.line(self.fenetre,rouge,self.liste_points[i],self.liste_points[i+1],epaisseur)
        else:
            for i in range(len(self.liste_points)-1):
                py.draw.line(self.fenetre,rouge,self.liste_points[i],self.liste_points[i+1],3)
